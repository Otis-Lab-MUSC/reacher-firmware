 ...
 */
void handleSetOmissionInterval(const char* cmd) {
  int32_t initOmissionInterval = extractParam(cmd, "SET_OMISSION_INTERVAL:");
...
Command commands[] = {
    ...
    {"SET_OMISSION_INTERVAL:", handleSetOmissionInterval},
