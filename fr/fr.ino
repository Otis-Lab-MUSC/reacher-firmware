...
void setup() {
  ...
  configureFixedRatio(scheduler, cue, pump, laser, 1, DeviceType::LEVER_RH, TRACE_INTERVAL);
...
void ReconfigureChain() {
  ...
  configureFixedRatio(scheduler, cue, pump, laser, currentRatio, timeoutTarget, TRACE_INTERVAL);
}
